...
public class Visitor extends compiladoresBaseVisitor<String> {
    ...
    public String visitProgram(ProgramContext ctx) {
        ...
        System.out.println("Intermediate code written to " + filePath);
    ...
    /*
     * Walk through the instructions of the program. An instruction is a sequence of
     * instructions.
    ...
    /*
     * Enter the return statement node, who has a logical arithmetic expression as a
     * child.
    ...
    /*
     * Enter the if statement node, who has a logical arithmetic expression, an
     * instruction and condition
     * 1. Get the logical arithmetic expression that tests the condition.
     * 2. Then we should declare the exit label where we are gonna jump if the
     * condition is false.
     * 3. We should declare the exit label for the else statement.
     * 4. We should declare the exit label for the else if statement.
     * 
     * if_stmt : IF O_PAREN logical_arithmetic_expression C_PAREN instruction
     * else_stmt
     * ;
     *
     * else_stmt : ELSE IF O_PAREN logical_arithmetic_expression C_PAREN instruction
     * else_stmt
     * | ELSE instruction
     * |
     * ;
    ...
    /*
     * A while statement is a node that contains a logical arithmetic expression and
     * a instruction.
     * 1. We should first declare the entry label where we are gonna jump if the
     * condition is true.
     * 2. We get the logical arithmetic expression that tests the condition.
     * 3. Then we should declare the exit label where we are gonna jump if the
     * condition is false.
     * 
     * while_stmt : WHILE O_PAREN logical_arithmetic_expression C_PAREN (instruction
     * | SEMICOLON)
     * ;
     */
    @Override
    ...
    /*
     * for_stmt : FOR O_PAREN for_declaration for_condition for_update C_PAREN
    ...
    /*
     * Enter a logical arithmetic expression node, that is a node that contains a
     * logical expression.
     * 
    ...
    /*
     * Enter the function statement node, who has a function declaration and a block
     * of code.
     * 
    ...
    /*
     * Enter the arithmetic expression node, who has only one children with
     * recursion.
     * 
